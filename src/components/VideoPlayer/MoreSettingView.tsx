...
export interface MoreSettingViewProps {
  isMuted: boolean;
  isDownload: boolean;
  volume: number;
  selectedRate: number;
  ...
  onFavoriteTapped: Function;
  onDownloadTapped: Function;
  onMuteVolumeTapped: Function;
  onVolumeChange: Function;
  onPlayRateChanged: Function;
  onEndTimeSelected: Function;
}

export default class MoreSettingView extends React.Component<
  MoreSettingViewProps,
  any
> {
  static defaultProps = {
    selectedRate: 1.0,
      ...
      <TouchableOpacity
        ...
        <View style={styles.contentView}>
          <View style={styles.optionView}>
            ...
            <TouchableOpacity
              style={[styles.itemView, {marginLeft: 40}]}
              onPress={this._onTapDownload}>
              <Image
            ...
            <TouchableOpacity
              style={[styles.itemView, {marginLeft: 40}]}
              onPress={this._onTapMute}>
              <Image
                source={
                  this.state.isMute
                    ? require('../../image/icon_video_muted.png')
                    : require('../../image/icon_video_mute.png')
                }
                style={styles.imageItem}
              />
              <Text
                style={[
                  styles.textItem,
                  this.state.isMute ? {color: '#ff5500'} : null,
                ]}>
                静音
              </Text>
            </TouchableOpacity>
