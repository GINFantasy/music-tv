 ...
 * @Description:
 * @Autor: GuluGuluu
 * @Date: 2022-12-07 13:09:34
 * @LastEditors: GuluGuluu
 * @LastEditTime: 2022-12-07 13:31:48
 */
import React from 'react';
import {View, Image, Text, TouchableOpacity, StyleSheet} from 'react-native';
import PropTypes from 'prop-types';

export interface ShareOptionViewProps {
  style: any;
  onCloseWindow: Function;
  onShareItemSelected: Function;
}

export default class ShareOptionView extends React.Component<
  ShareOptionViewProps,
  any
> {
  static propTypes = {
          ...
          {shareOptions.map((item, index) => {
            return (
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                onPress={() => {
                  this.shareItemSelectedAtIndex(index);
                }}>
                <Image source={item.imageRef} style={styles.image} />
