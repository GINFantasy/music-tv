...
> {
      ...
      <View
        ...
        <TouchableWithoutFeedback onPress={this._onTapVideo}>
          <View
            style={{
              ...
              width: this.state.videoWidth,
              height: this.state.videoHeight,
              backgroundColor: this.state.isPaused
                ? 'rgba(0, 0, 0, 0.2)'
                : 'transparent',
              alignItems: 'center',
        ...
        {this.state.isShowControl ? (
          <View style={[styles.bottomControl, {width: this.state.videoWidth}]}>
            ...
            <Slider
              ...
              thumbProps={{
                children: <Ionicons name="ellipse" size={16} color={'white'} />,
              }}
            ...
            {this.state.isFullScreen ? (
              <View style={styles.bottomOptionView}>
                ...
                <TouchableOpacity onPress={this._onTapSelectVideo}>
                  <Text style={[styles.bottomOptionText, {marginLeft: 10}]}>
                    选集
                  </Text>
                </TouchableOpacity>
              </View>
          ...
          <View
            ...
            {this.state.isFullScreen ? (
              <View style={styles.topOptionView}>
                <TouchableOpacity
                  style={styles.topOptionItem}
                  onPress={this._onTapCaptureImage}>
                  <Image
                ...
                <TouchableOpacity
                  style={styles.topOptionItem}
                  onPress={this._onTapAirplayButton}>
                  <Image
                ...
                <TouchableOpacity
                  style={styles.topOptionItem}
                  onPress={this._onTapShareButton}>
                  <Image
        ...
        {this.state.isFullScreen && this.state.isDefinitionShow ? (
          <SelectDefinitionView
            ...
            onCloseWindow={() => {
              this.setState({isDefinitionShow: false});
            }}
          />
        ) : null}
        {this.state.isFullScreen && this.state.isVideoListShow ? (
          <SelectVideoView
            ...
            onCloseWindow={() => {
              this.setState({isVideoListShow: false});
            }}
          />
        ) : null}
        {this.state.isFullScreen && this.state.isShareMenuShow ? (
          <ShareOptionView
            ...
            onShareItemSelected={index => {
              this.onShareMenuPressed(index);
            }}
            onCloseWindow={() => {
        ...
        {this.state.isFullScreen && this.state.isSettingViewShow ? (
          <MoreSettingView
            ...
            onFavoriteTapped={() => {
              this.setState({isSettingViewShow: false});
            }}
            onDownloadTapped={() => {
              this.setState({isSettingViewShow: false});
            }}
            onMuteVolumeTapped={isMute => {
              this.onMuteVolume(isMute);
            }}
            onPlayRateChanged={rate => {
              this.onPlayRateChange(rate);
            }}
            onEndTimeSelected={index => {
  ...
  _onTapSwitchButton = () => {
    this.props.onChangeOrientation &&
      this.props.onChangeOrientation(this.state.isFullScreen);
  };
